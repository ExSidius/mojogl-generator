...
class GLRegistry:
    ...
    def generate_core_file(self, output_path: Path, version: str) -> None:
        ...
        for cmd_name in sorted(command_names):
            ...
            for param in cmd.params:
                ...
                param_parts.append(f"{param.name}: {mojo_type}")
            ...
            content.append(f"var {cmd.name}: fn({param_str}) -> {return_mojo_type}")
    ...
    def generate_loader_file(self, output_path: Path, version: str) -> None:
        ...
        content = [
            ...
            "",
            f"fn load_gl_core_{version_safe}(lib: OwnedDLHandle) raises:",
